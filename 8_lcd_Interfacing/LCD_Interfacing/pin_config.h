...
#include <avr/interrupt.h>									// Standard AVR Interrupt Library
	...
	#define		current_sensor_ddr_reg			DDRF
	#define		current_sensor_port_reg			PORTF
	#define		current_sensor_pin				PF1			// 1
	#define		current_sensor_channel			1			// ADC1 - ADC channel 1
